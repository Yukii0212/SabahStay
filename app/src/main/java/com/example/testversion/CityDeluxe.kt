...
class CityDeluxe: AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_city_deluxe)
        ...
        roomImage.setOnClickListener {
            ...
            intent.putExtra("imageResId", R.drawable.city_deluxe)
