...
class IslandDeluxe: AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_island_deluxe)
        ...
        roomImage.setOnClickListener {
            ...
            intent.putExtra("imageResId", R.drawable.island_deluxe)
